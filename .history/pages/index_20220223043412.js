          ...
          <div className="space-x-2">
            {!isUserWalletConnected && (
              <button
                ...
                className="w-[166px] bg-pink-500 active:trans  text-white font-bold py-2.5 px-5 hover:opacity-75 transition-opacity duration-300 rounded-xl shadow-slate-500 shadow-sm "
              >
                Connect Wallet
              </button>
            )}
