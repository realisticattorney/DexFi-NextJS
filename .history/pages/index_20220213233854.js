...
export default function Home(props) {
  ...
  async function swap() {
    ...
    const exchangeUserConnection = new ethers.Contract(
      ...
      const wasApproved = await tokenUserConnection.approve(scammExchangeAddress, inputOne);
      
      console.log("we are good til this point too")

    //   const allowanceAmount = ethers.utils.formatEther(
    //     await tokenUserConnection.allowance(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266, scammExchangeAddress)
    //     );
