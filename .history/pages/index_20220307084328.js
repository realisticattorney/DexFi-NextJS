      ...
      <div className="w-full bg-[#FAF9FA]">
        <div className="w-full grid bg-[#FAF9FA] grid-cols-2 grid-rows-1 max-w-[1200px] mx-auto pb-24 pt-10">
          <div className="flex-col px-6 py-32 flex-grow">
            ...
            <div className="mt-9">
              <Link href="/swap">
                <a className="sm:w-[166px] col-span-2 bg-pink-500 active:translate-y-0.1 active:shadow-none active:opacity-90  text-white font-bold py-3 px-7 hover:opacity-75 transition-opacity duration-300 rounded-xl shadow-slate-400 shadow-sm ">
                  Trade Now
                </a>
              </Link>
              <Link href="/swap">
