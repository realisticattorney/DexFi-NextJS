        ...
        <div className="flex-col py-5 w-[326px] h-[518px] bg-white rounded-3xl border ">
          ...
          <div className="flex flex-col space-y-2 p-5">
            ...
            >
              ...
              <div className='h-10 '>
              {inputOne !== null && inputSecond !== null && inputOne !== 0 && inputOne !== 0 (
                
                <div className='flex w-full justify-evenly'>
                <h1>Price</h1>
                <h1 className='truncate text-sm'>{`${(inputOne / inputSecond).toString().length > 9 ? (inputOne / inputSecond).toString().substring(0, 10) : (inputOne / inputSecond).toString()} ${currencies[selectedIndex].symbol} per ${currencies[selectedIndexSecond].symbol}`}</h1></div>
              )}
              </div>
          <div className='mx-5 '>
            <button
