        ...
        <div className="heroBackground ">
          <div className="flex-col items-center mx-auto flex">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 px-5 gap-5 mb-10">
              ...
              <div className='h-[280px]'> <svg viewBox="0 0 1660 48" preserveAspectRatio="none" color="text" width="20px" xmlns="http://www.w3.org/2000/svg" class="sc-bdvvtL wPKGk"><path d="M1660 48C1139.02 46.1887 336.256 15.2453 0 0H1660V48Z"></path></svg></div>
      </div>
    </div>
  );
};
