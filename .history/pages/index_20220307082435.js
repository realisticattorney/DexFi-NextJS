          ...
          <div className="space-x-2">
            {!isAuthenticated && (
              <button
                ...
                className="sm:w-[166px] bg-pink-500 active:translate-y-0.1 active:shadow-none active:opacity-90  text-white font-bold py-2.5 px-5 hover:opacity-75 transition-opacity duration-300 rounded-xl shadow-slate-500 shadow-sm "
              >
                Connect Wallet
              </button>
            )}
