      ...
      <div className="w-full grid grid-cols-2 grid-rows-1 max-w-[1200px] mx-auto mt-24">
        <div className="flex-col px-6 py-40 flex-grow space-y-6">
          ...
          <div className="space-x-2">
            ...
            <Link href="/swap">
              <a className="w-[132px] border-pink-500 border-2 font-bold py-2.7 px-5 rounded-xl shadow-sm text-pink-500 hover:opacity-60 transition-opacity duration-300 active:translate-y-0.1 active:shadow-none active:opacity-90">
                Trade Now
              </a>
            </Link>
          </div>
