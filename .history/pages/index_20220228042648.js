        ...
        <div className="w-full grid bg-[#FAF9FA] grid-cols-2 grid-rows-1 max-w-[1200px] mx-auto pb-24 pt-10">
          <div className="flex-col px-6 py-32 flex-grow">
            ...
            <div className="mt-9">
              ...
              <Link href="/swap">
                <a className="w-[166px] active:translate-y-0.1 active:shadow-none active:opacity-90 mx-5 text-pink-400 font-extrabold  hover:opacity-75 transition-opacity duration-300  ">
                  Learn
                </a>
              </Link>
            </div>
