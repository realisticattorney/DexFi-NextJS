      ...
      <div className="mt-5">
        ...
        <div className="w-full grid grid-cols-2 grid-rows-1 max-w-[1200px] mx-auto mt-24">
          <div className="flex-col px-6 py-40 flex-grow space-y-6">
            ...
            <div className="space-x-2">
              <Link href="/swap">
                <a className="w-[166px] bg-pink-500 active:translate-y-0.1 active:shadow-none active:opacity-90  text-white font-bold py-3 px-7 hover:opacity-75 transition-opacity duration-300 rounded-xl  shadow-sm ">
                  Trade Now
                </a>
              </Link>
            </div>
