...
import { scammcoinAddress, scammExchangeAddress, USDCAddress, ETCAddress } from '../config-local.js';
...
export default function Liquidity(props) {
  ...
  const fetchContractEvents = async () => {
    const options = {
      ...
      topic: "0xc57A4B1B2505C24BcF1d8cA857aE153b6Be8D122",
      abi: Exchange.abi,
    };
                    ...
                    <AccordionDetails>
                      <div className="flex flex-col py-1">
                        ...
                        <button
                          ...
                          onClick={() =>
                            setExchange(currency.connectToAbi.address, currency.symbol)
                          }
                        >
                          Remove
                        </button>
