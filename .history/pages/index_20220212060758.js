...
export default function Home(props) {
  ...
  async function swap() {
    ...
    //o sea se tiene que chequear en el registry cuando se cambia el selectedIndex si currencies[selectedIndex].address esta en el registry, y si esta llamo aca al get
