...
export default function Home(props) {
  ...
  async function callExchange(input, id) {
    ...
    if (input === '1') {
      ...
      price = await ethers.utils.parseEther(input);
    }
    console.log('price', ethers.utils.formatEther(price));
    console.log("la concha de tu madre", ethers.utils.formatEther(await exchange.getEthAmount(ethers.utils.parseEther("1"))))
    let amount;
