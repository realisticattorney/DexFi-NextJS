  ...
  return (
    <div>
      <div className="w-full grid grid-cols-2 grid-rows-2 sm:grid-rows-1 sm:max-w-[1200px] sm:mx-auto sm:mt-24">
        <div className="flex-col px-6 sm:px-6 sm:py-40  -mt-7 sm:mt-0 flex-grow space-y-3 sm:space-y-6 row-start-2 sm:row-start-1 col-span-2 sm:col-span-1">
        ...
        <div className="heroBackground ">
          <div className="flex-col items-center mx-auto flex">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 px-5 gap-5 mb-10">
              <div className="bg-white h-[280px] sm:w-[280px] rounded-3xl shadow-sm shadow-slate-300 py-5 px-6 ">
      ...
      <div className="w-full bg-[#FAF9FA]">
        <div className="w-full grid bg-[#FAF9FA] grid-cols-2 grid-rows-2 sm:grid-rows-1 max-w-[1200px] mx-auto pb-16 sm:pb-24 pt-0 sm:pt-10">
          <div className="flex-col px-6 sm:py-32 flex-grow row-start-2 sm:row-start-1 col-span-2 sm:col-span-1">
            ...
            <div className="mt-9">
              <Link href="/swap">
                <a className="sm:w-[166px] bg-pink-500 active:translate-y-0.1 active:shadow-none active:opacity-90  text-white font-bold py-3 px-7 hover:opacity-75 transition-opacity duration-300 rounded-xl shadow-slate-400 shadow-sm ">
                  Trade Now
                </a>
              </Link>
              <Link href="/swap">
                <a className="sm:w-[166px] active:translate-y-0.1 active:shadow-none active:opacity-90 mx-5 text-pink-500 font-extrabold  hover:opacity-75 transition-opacity duration-300  ">
                  Learn
                </a>
              </Link>
            </div>
          </div>
          <CoinWrapper className="mx-5 row-start-1 col-start-2">
            <Image
              src="/BNB.png"
              layout="fill"
              alt="lol"
