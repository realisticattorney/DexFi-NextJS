                  ...
                  <Accordion className={classes.hideBorder}>
                    ...
                    <AccordionDetails>
                      <div className="flex flex-col py-1">
                        ...
                        <button className="w-full hover:opacity-75 transition-opacity duration-150 mt-2   text-pink-500 font-bold rounded-2xl active:translate-y-0.1 active:shadow-none active:opacity-90">
