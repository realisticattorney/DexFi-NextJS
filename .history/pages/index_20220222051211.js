    ...
    <div className="w-full grid grid-cols-2 grid-rows-1 max-w-[1200px] mx-auto">
      <div className="flex-col px-6 py-40 flex-grow space-y-6">
        ...
        <div className="space-x-2">
          <button className="w-[166px] bg-pink-500  text-white font-bold py-2.5 px-5 hover:opacity-70 transition-opacity duration-300 rounded-xl shadow-slate-500 shadow-sm">
            Connect Wallet
          </button>
