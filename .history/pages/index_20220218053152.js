    ...
    <div className="flex-col ">
      ...
      <div className="p-6 mx-auto w-min">
        <div className="flex-col relative py-5 w-[326px] h-[518px] bg-white rounded-3xl border shadow-sm">
          ...
          {''}
          {''}
          <MenuItemList handleOpen={handleOpenSecond} handleClose={handleClose} currencies={currencies} token={outputToken} open={openSecond} input={inputTwo} handleInputChange={handleInputOneChange}
          handleMenuItemClick={handleMenuItemClick} key={1} menuNumber={2} />
