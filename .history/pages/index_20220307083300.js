...
const Home = () => {
  ...
  return (
    <div>
      <div className="w-full grid auto-rows-auto grid-cols-2 grid-rows-2 sm:grid-rows-1 sm:max-w-[1200px] sm:mx-auto sm:mt-24">
        ...
        <BunnyWrapper className="col-span-1 auto-rows-auto col-start-2 relative row-span-1 z-0">
          <Image
            src="/bunnyHome.png"
            layout="fill"
            alt="lol"
