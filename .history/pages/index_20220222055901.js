        ...
        <div className="heroBackground ">
          <div className="flex-col items-center mx-auto flex">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 px-5 gap-5 mb-10">
              <div className="bg-white h-[280px] w-[280px] rounded-3xl shadow-sm shadow-slate-300">
              <h1 className="mt-5 text-4xl text-center ] font-bold tracking-wide text-dexfi-violet">
              Used by millions.
            </h1>
              </div>
