...
const Home = () => {
  ...
  return (
    <div>
      <div className="max-w-fit grid grid-cols-2 grid-rows-2 sm:grid-rows-1 sm:max-w-[1200px] sm:mx-auto mt-5 sm:mt-24">
        <div className="flex-col px-6 sm:py-40 flex-grow space-y-6 row-start-2 sm:row-start-1 col-span-2 sm:col-span-1">
          <h1 className="text-3xl tracking-wide font-bold text-dexfi-moon">
