                  ...
                  <Accordion className={classes.hideBorder}>
                    ...
                    <AccordionDetails>
                      <div className="flex flex-col py-1">
                        ...
                        <a className="w-full text-center cursor  hover:opacity-75 transition-opacity duration-150 mt-2.5 text-sm  bg-pink-500 shadow-sm text-white font-bold py-2.5 px-12 rounded-xl active:translate-y-0.1 active:shadow-none active:opacity-90">
                          Remove
                        </a>
