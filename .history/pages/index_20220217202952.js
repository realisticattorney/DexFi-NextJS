...
export default function Home(props) {
  ...
  const [inputToken, setInputToken] = useState({prevToken: null, currentToken: [currencies[0], 0]});
  ...
  const handleInputToken = useCallback(t => {
    setInputToken(t => {
      return {prevToken: t.currentToken , inputToken}});
  }, [inputToken]);
