...
const CoinWrapper = styled.div`
  ...
  & :nth-child(2) > :first-child {
    animation: ${floatingAnim('3px', '19px')} 3s ease-in-out infinite;
    animation-delay: 1s;
  }

  & > span :nth-child(3) > :first-child {
    animation: ${floatingAnim('5px', '12px')} 3s ease-in-out infinite;
    animation-delay: 0.66s;
  }
  & > span :nth-child(2) > img {
    animation: ${floatingAnim('10px', '10px')} 2.5s ease-in-out infinite;
