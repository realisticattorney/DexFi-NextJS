    ...
    <div>
      ...
      <div className="mt-5">
        ...
        <div className='flex-col items-center mx-auto flex'>
          ...
          <h2 className='mt-10 text-center w-[500px] font-semibold text-dexfi-violet'>
          PancakeSwap has the most users of any decentralized platform, ever.
          </h2>
          <h2 className=' mb-5 text-center w-[580px] font-semibold text-dexfi-violet textopa'>
          And those users are now entrusting the platform with over $12 billion in funds.
          </h2>
          <h2 className=' mb-5 text-center w-[580px] font-bold text-dexfi-violet'>
          Will you join them?
          </h2>
