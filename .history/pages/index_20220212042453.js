...
export default function Home(props) {
  ...
  async function callExchange(input, id) {
    ...
    if (selectedIndex !== 1) {
      ...
      amount = id === "outlined-number-1" ? ethers.utils.formatEther(await exchange.getTokenAmount(price2)) : ethers.utils.formatEther(await exchange.getTokenAmount(price2));
    }
