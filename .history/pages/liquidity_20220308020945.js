...
export default function Liquidity(props) {
  ...
  return (
    <div className="flex-col ">
      ...
      <div className="p-6 mt-1 mb-10 sm:p-6 sm:mb-0 sm:mt-0 mx-auto w-fit sm:w-min">
        <div className="flex-col relative sm:w-[436px] min-h-[273px] bg-white rounded-3xl border shadow-sm">
          ...
          <div className="bg-dexfi-backgroundgray py-2 sm:py-4 px-3 sm:px-6">
            {user && userLps && userLps.length > 0 ? (
              ...
              <div className="h-[72px] p-3 mx-auto text-center">
                {user ? (
                  userLps && userLps.length === 0 ? (
                    <h1 className="font-medium text-dexfi-grayviolet">
                      You have no liquidity
                    </h1>
                  ) : (
                    <h1 className="font-medium text-dexfi-grayviolet">Loading</h1>
                  )
                ) : (
                  <h1 className="font-medium text-dexfi-grayviolet">
            ...
            {userLps && userLps.length > 0 && (
              <div className="sm:h-[80px] flex flex-col text-center p-4">
