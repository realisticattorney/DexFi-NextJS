    ...
    <div className="flex-col ">
      ...
      <div className="p-6 mx-auto w-min">
        <div className="flex-col relative py-5 w-[326px] h-[518px] bg-white rounded-3xl border shadow-sm">
          ...
          {''}
          {''}
          <MenuItemList handleOpen={handleOpen} handleClose={handleClose} currencies={currencies} token={inputToken} open={openSecond} input={inputTwo} handleInputChange={handleInputOneChange}
