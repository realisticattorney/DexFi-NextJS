          ...
          <div className="flex flex-col space-y-2 p-5">
            ...
            >
              ...
              {inputOne !== null && inputSecond !== null && (
                ...
                div
                <h1 className='truncate text-sm'>{`${(inputOne / inputSecond).toString().length > 9 ? (inputOne / inputSecond).toString().substring(0, 10) : (inputOne / inputSecond).toString()} ${currencies[selectedIndex].symbol} per ${currencies[selectedIndexSecond].symbol}`}</h1>
              )}
              </div>
          <div className='mx-5 '>
            <button
