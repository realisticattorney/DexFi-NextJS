        ...
        <div className="w-full grid bg-[#FAF9FA] grid-cols-2 grid-rows-1 max-w-[1200px] mx-auto pb-24 pt-10">
          <div className="flex-col px-6 py-32 flex-grow">
            ...
            <div className="space-x-2 mt-9">
              ...
              <Link href="/swap">
                <a className="w-[166px] bg-pink-500 active:translate-y-0.1 active:shadow-none active:opacity-90  text-white font-bold py-3 px-7 hover:opacity-75 transition-opacity duration-300  ">
                  Learn
                </a>
              </Link>
            </div>
