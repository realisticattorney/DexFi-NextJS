      ...
      <div className="p-6 mx-auto w-min">
        <div className="flex-col relative w-[436px] min-h-[273px] bg-white rounded-3xl border shadow-sm">
          ...
          <div className="h-[100px] py-3 px-6 mx-auto text-center ">
            <Link href="/add">
              <a>
                <button className="w-full hover:opacity-75 flex self-center transition-opacity duration-150  bg-pink-500 shadow-sm text-white font-bold py-3 px-12 rounded-2xl active:translate-y-0.1 active:shadow-none active:opacity-90">
                  + Add Liquidity
                </button>
              </a>
            </Link>
