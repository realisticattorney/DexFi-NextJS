  ...
  return (
    <div className="w-full grid grid-cols-2 grid-rows-1">
      <div className="flex-col">
        <h1 className='text-6xl tracking-widest font-bold text-dexfi-moon'>The moon is made of pancakes.</h1>
      ...
      <div className="col-span-1 relative row-span-1 flex-grow flex">
