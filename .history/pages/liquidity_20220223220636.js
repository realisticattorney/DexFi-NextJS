      ...
      <div className="p-6 mx-auto w-min">
        <div className="flex-col relative w-[436px] min-h-[273px] bg-white rounded-3xl border shadow-sm">
          ...
          <div className="bg-dexfi-backgroundgray py-4 px-6">
            ...
            <Link href="/swap">
              <a>
                <button className="w-full border-pink-500 border-2 font-bold py-2.5 px-5 rounded-xl shadow-sm text-pink-500 hover:opacity-75 transition-opacity duration-300 active:translate-y-0.1 active:shadow-none active:opacity-90">
                  Trade Now
                </button>
              </a>
            </Link>
