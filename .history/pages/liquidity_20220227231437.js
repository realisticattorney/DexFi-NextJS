                    ...
                    <AccordionDetails>
                      <div className="flex flex-col py-1">
                        ...
                        <Link href={`/remove/${account}_${currency.symbol}/`}>
                          <b className="w-full text-center cursor-pointer  hover:opacity-75 transition-opacity duration-150 mt-2.5 text-sm  bg-pink-500 shadow-sm text-white font-bold py-2.5 px-12 rounded-xl active:translate-y-0.1 active:shadow-none active:opacity-90">
                            Remove
                          </b>
                        </Link>
                        <Link href="/add">
