  ...
  useEffect(() => {
    async function loadExchange(a, b, c, d) {
      ...
      if (exchange === null) {
        ...
        setInputOne(null);
        setInputSecond(null);//I should check whether this is changing from token-eth to eth-token or token-token. In the first case, no need to reset the inputs. The latter, 
