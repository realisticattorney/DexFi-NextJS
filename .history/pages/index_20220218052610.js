    ...
    <div className="flex-col ">
      ...
      <div className="p-6 mx-auto w-min">
        <div className="flex-col relative py-5 w-[326px] h-[518px] bg-white rounded-3xl border shadow-sm">
          ...
          <MenuItemList handleOpen={handleOpenSecond} handleClose={handleCloseSecond} currencies={currencies} token={outputToken} open={openSecond} input={inputTwo} handleInputOneChange={handleInputOneChange} />
          {inputOne !== null &&
            inputTwo !== null &&
            inputOne !== '0' &&
            inputTwo !== '0' && (
