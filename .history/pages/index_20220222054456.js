  ...
  return (
    <div>
      ...
      <div className="mt-5">
        ...
        <div className='heroBackground h-[400px]'>
        <div className='flex-col items-center mx-auto flex'>
          <h1 className='text-xl text-center w-[311px] font-bold tracking-wide text-dexfi-violet'>
            Swap, earn, and win crypto on the most popular decentralized
            platform in the galaxy.
          </h1>
          <h1 className='text-xl text-center w-[360px] font-bold tracking-wide text-dexfi-violet'>
