      ...
      <div className="p-6 mx-auto w-min">
        ...
        >
          ...
          <div className="justify-self-end">
            <button
              type="submit"
              className="inline-flex font-mono font-light items-center self-center justify-center py-1.2 mt-2 w-32 border border-transparent shadow text-xl  text-white bg-black focus:outline-none focus:ring-1 focus:ring-offset-2 active:outline-none"
            >
              Submit
            </button>
          </div>
