...
export default function Home(props) {
  ...
  async function swap() {
    ...
    //a esta altura ya hay deployado un contrato para este par de monedas. asi que hay que conectarlo de una. lo que si estaria bueno agregar es el searchbar en el modal donde si no 
