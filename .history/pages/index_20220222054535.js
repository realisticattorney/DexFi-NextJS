    ...
    <div>
      ...
      <div className="mt-5">
        ...
        <div className='flex-col items-center mx-auto flex'>
          <h1 className='text-5xl text-center w-[311px] font-bold tracking-wide text-dexfi-violet'>
            User by millions.
          </h1>
          <h1 className='text-5xl text-center w-[360px] font-bold tracking-wide text-dexfi-violet'>
