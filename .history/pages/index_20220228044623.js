          ...
          <div className="flex-col items-center mx-auto flex">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 px-5 gap-5 mb-10">
              <div className="bg-white h-[280px] w-[280px] rounded-3xl shadow-sm shadow-slate-300 p-5 ">
                <h1 className="mt-26 text-4xl tracking-tight  font-extrabold text-dexfi-violet">
                  3.6 million
                </h1>
                <h1 className="text-4xl mt-1 font-extrabold text-dexfi-moon">
                  users
                </h1>
              ...
              <div className="bg-white h-[280px] w-[280px] rounded-3xl shadow-sm shadow-slate-300 p-5 ">
                ...
                <h1 className="text-4xl mt-1 font-extrabold text-cyan-400">
                  trades
                </h1>
                <h2 className="mt-7 font-semibold text-dexfi-violet text-opacity-70">
              ...
              <div className="bg-white h-[280px] w-[280px] rounded-3xl shadow-sm shadow-slate-300 p-5 ">
                ...
                <h1 className="text-4xl mt-1 font-extrabold text-pink-500">
                  staked
                </h1>
                <h2 className="mt-7 font-semibold text-dexfi-violet text-opacity-70">
                  Total Value Locked
