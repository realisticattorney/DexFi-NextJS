                  ...
                  <Accordion className={classes.hideBorder}>
                    ...
                    <AccordionDetails>
                      <div className="flex flex-col py-1">
                        ...
                        <button className="w-full hover:opacity-75 transition-opacity duration-150 mt-2 text-sm  bg-pink-500 shadow-sm text-white font-bold py-2.5 px-12 rounded-2xl active:translate-y-0.1 active:shadow-none active:opacity-90">
                          Remove
                        </button>
