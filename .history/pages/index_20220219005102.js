...
const Icon = styled((props) => (
  <div {...props}>
    <div className="n py-1.3 px-1.7 rounded-full  bg-pink-500 shadow transition-transform hidden hover:block">
      <ImportExportIcon />
    </div>
    <div className="y py-1.3 px-1.7 rounded-full  bg-gray-100 shadow hover:hidden">
      <ArrowDownwardIcon />
    </div>
  </div>
))`
