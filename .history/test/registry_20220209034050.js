...
describe('Registry deployment', function () {
  beforeEach(async function () {
    ...
    registry = await Registry.deploy(); //do not define registry as const, it won't make it outside the beforeEach function
  ...
  it('ScammExchange instance is in Registry mapping', async function () {
    ...
    expect(scammExchange).to.equal(token.address);
