...
async function main() {
  ...
  const scammExchangeContract = await Exchange.attach('0xA055a2cd9283699662E21265D161a6fC8c89Dcd9');
  const USDCExchangeContract = await Exchange.attach('0x40ab42E51fA2B796490F7DA4df1B43752E63DaAC');
  const ETCExchangeContract = await Exchange.attach('0x2b9692498627141c2826dE77a2bC815D068fd2Aa');
