  ...
  useEffect(() => {
    ...
    const loadExchange = async () => {
      ...
      const exchangeBalance = ethers.utils.formatEther(
        await provider.getBalance(exchangeCurrent.contract.address)
      );
      const getReserve = ethers.utils.formatEther(await exchangeCurrent.contract.getReserve());
      const totalSupply = ethers.utils.formatEther(
        await exchangeCurrent.contract.totalSupply()
      );
