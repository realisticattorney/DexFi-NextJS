    ...
    <div className="flex border-b-1.5 border-gray-200 p-0 items-center">
      ...
      <div className="ml-auto mr-3 flex">
        <Link href={`/swap`} passHref>
          <div className="flex mx-3 space-x-1 cursor-pointer hover:last:scale-100  hover:first:scale-105 transition-transform duration-75 ">
            <div><Image src="/logo.png" height={24} width={26} alt="" /></div>
