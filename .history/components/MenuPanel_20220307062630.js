...
const MenuPanel = ({ currencies, section }) => {
  ...
  const { isAuthenticated, authenticate, user, logout, isInitialized } =
    useMoralis();
        ...
        <div className="p-4 mx-4 mt-4 bg-orange-50 border border-orange-300 rounded-3xl">
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <h1 className="text-dexfi-violet text-sm font-medium">
                By adding liquidity you{"'"}ll set the price relation between tokens.
              </h1>
            </div>
          </div>
        </div>
