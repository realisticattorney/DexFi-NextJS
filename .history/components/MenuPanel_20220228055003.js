...
const MenuPanel = ({ currencies, section }) => {
  ...
  return (
    <>
      ...
      <div className="flex-col mt-4 relative py-5 w-[328px] h-[95px] bg-white rounded-3xl border border-gray-50">
        <div className="flex justify-between">
          <h2 className="text-dexfi-grayviolet font-medium textsm">Dark mode</h2>
