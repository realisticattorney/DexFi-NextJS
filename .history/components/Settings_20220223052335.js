            ...
            >
              ...
              <div className="w-full p-6 bg-white rounded-br-3xl rounded-bl-3xl">
                <div className="flex flex-col">
                  ...
                  <div className="flex justify-between">
                    <button className="shadow-sm text-white py-0.7 px-5 bg-dexfi-cyan  rounded-3xl font-bold hover:opacity-75 transition-opacity duration-200 active:translate-y-0.1 active:shadow-none active:opacity-90">
                      Standard{" (5)"}
                    </button>
                  </div>
