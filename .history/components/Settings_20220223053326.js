              ...
              <div className="w-full p-6 bg-white rounded-br-3xl rounded-bl-3xl">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex justify-between my-4">
                    ...
                    <button className="shadow-sm text-dexfi- py-0.5 px-4 bg-gray-100   rounded-3xl font-medium hover:opacity-75 transition-opacity duration-200 active:translate-y-0.1 active:shadow-none active:opacity-90">
                    0.50
                    </button>
