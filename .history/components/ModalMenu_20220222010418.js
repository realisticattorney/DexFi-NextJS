      ...
      >
        ...
        >
          ...
          <ul className="absolute left-0 top-0 mt-10  w-[280px] rounded-2xl border shadow-sm bg-white z-10 hidden group-hover:block">
            ...
            <li className="ml-3 whitespace-no-wrap flex items-center text-gray-600 hover:text-gray-800 border-b border-t">
              <Link href="/pools">
                <a className=" text-gray-500 h-[48px] my-2 flex hover:bg-gray-100 w-full items-center font-semibold">Leaderboard</a>
              </Link>
            </li>
            <li className="px-2 whitespace-no-wrap h-[48px] flex items-center text-gray-600 hover:text-gray-800 hover:bg-gray-100">
              <Link href="/pools">
