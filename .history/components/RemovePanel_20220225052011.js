    ...
    <div className="flex flex-col p-6">
      ...
      <div className="border my-5 p-4 rounded-2xl ">
        ...
        <div className="flex justify-between my-4">
          ...
          <button
            className={`shadow-sm text-dexfi-cyan py-0.5 px-4 bg-gray-100   rounded-3xl font-bold hover:opacity-75 transition-opacity duration-150 active:translate-y-0.1 active:shadow-none active:opacity-90 ${userLpsToRemove === 50 ? ' text-white' : 'text-dexfi-cyan'}`}
            onClick={() => {
