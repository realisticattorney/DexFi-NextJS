    ...
    <>
      ...
      <div className="flex-col mt-4 relative py-4 w-[328px] h-[95px] bg-white rounded-3xl border border-gray-50">
        <div className="flex justify-between px-4">
          <h2 className="text-dexfi-grayviolet font-medium text-sm">Minimun received</h2>
          <h2 className="text-dexfi-violet font-medium text-sm">0.0</h2>
        </div>
        <div className="flex justify-between px-4">
          <h2 className="text-dexfi-grayviolet font-medium text-sm">Price Impact</h2>
          <h2 className="text-dexfi-violet font-medium text-sm">0.0</h2>
        </div>
        <div className="flex justify-between px-4">
          <h2 className="text-dexfi-grayviolet font-medium text-sm">Liquidity Provider Fee</h2>
          <h2 className="text-dexfi-violet font-medium text-sm">0.0</h2>
        </div>
      </div>
    </>
