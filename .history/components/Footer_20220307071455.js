...
const Footer = () => {
  ...
  return (
    <footer className=" text-white  font-medium  p-5 bg-dexfi-space_gray">
      <div className="grid col-span-3 grid-cols-1 mx-6  grid-flow-row sm:grid-rows-4   md:grid-cols-4 md:grid-rows-1 mt-8">
        ...
        <div className="flex col-span-1 row-span-1 self-start hidden  sm:place-self-end">
