    ...
    <footer className=" text-white  font-medium  p-5 bg-dexfi-space_gray">
      ...
      <div className="flex space-x-6 items-center px-6 pt-10 pb-7 w-full border-b border-gray-700">
        ...
        <Link href="/swap">
              <a></a>
        <button
          className=" text-white font-bold py-1 px-4 shadow-sm tracking-wide bg-pink-500 rounded-full hover:opacity-75 transition-opacity duration-200 active:translate-y-0.1 active:shadow-none active:opacity-90"
        >
          Buy SCAM -{">"}
        </button>
        </div>
