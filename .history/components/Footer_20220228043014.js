    ...
    <footer className=" text-white  font-medium  p-5 bg-dexfi-space_gray">
      ...
      <div className="flex justify-between py-9 pb-4">
        ...
        <div className="items-center flex">
          ...
          <Link href="/swap">
            <a>
              <button className=" text-white font-bold py-1 px-4 shadow-sm tracking-wide bg-pink-500 rounded-full hover:opacity-75 transition-opacity duration-150 active:translate-y-0.1 active:shadow-none active:opacity-90 mr-5">
                Buy SCAM -{'>'}
              </button>
            </a>
          </Link>
