              ...
              <Paper sx={modalstyle}>
                ...
                >
                  ...
                  <div className="w-full p-6 bg-white">
                    ...
                    <h2 className="text-violet-700 font-semibold text-sm mb-2.5">Your Address</h2>
                    <h2 className="bg-gray-100 p-2 rounded-2xl text-dexfi-violet font-bold text-lg text-center">0xf389aaabsdb423f2l3490dd0BBB9S</h2>
                    <div className="p-3 bg-orange-100 border border-orange-300 rounded-2xl">
