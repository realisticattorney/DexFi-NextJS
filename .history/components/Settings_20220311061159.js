                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex justify-between my-4">
                    ...
                    */}
                    ...
                    <p className='text-orange-500 text-sm font-medium'>{slippage < 0.1 ? "Your transaction may fail" : slippage > 5 ? "Your transaction may be frontrun" : slippage > 50 ? "Enter a valid slippage "}</p>
                </div>
              </div>
            </MenuList>
          </Paper>
