...
const MenuPanelFooter = ({
  ...
  if (inputOne > 0 && section === 'Exchange') {
    return (
  ...
  } else if(inputOne > 0 && section === 'Liquidity') {
    return (
      <div className="flex-col mt-5 relative py-4 w-[328px] h-[95px] bg-white rounded-3xl border border-gray-50"></div>
    );
  }
};
