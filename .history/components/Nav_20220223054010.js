  ...
  return (
    <div className="flex border-b-1.5 border-gray-200 p-0 items-center">
      ...
      {isUserWalletConnected ? (
        <>
          <button
            className=" mr-4 text-violet-900 font-bold py-0.8 px-6 shadow-slate-400 shadow-sm tracking-wide bg-gray-100 rounded-full relative z-40 group hover:opacity-90 cursor-pointer"
            disabled={true}
          >
