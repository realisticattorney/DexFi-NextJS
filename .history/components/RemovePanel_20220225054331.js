...
const RemovePanel = ({ address, currency }) => {
  ...
  return (
    <div className="flex flex-col p-6">
      ...
      <h1 className="text-xs text-dexfi-grayviolet font-bold mt-4">YOU WILL RECEIVE</h1>
      <div className='my-4 bg-gray-100 w-full p-4 border border-slate-200 rounded-2xl'></div>
    </div>
  );
};
