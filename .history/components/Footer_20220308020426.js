...
const Footer = () => {
  ...
  return (
    <footer className=" text-white  font-medium  p-0 sm:p-5 bg-dexfi-space_gray">
      <div className="grid col-span-3 grid-cols-1 mx-3 sm:mx-6  grid-flow-row sm:grid-rows-4   md:grid-cols-4 md:grid-rows-1 mt-8">
      ...
      <div className="flex justify-between py-6">
        ...
        <div className="items-center flex">
          ...
          <Link href="/swap">
            <a>
              <button className=" text-white font-bold py-1 px-4 shadow-sm tracking-wide bg-pink-500 rounded-full hover:opacity-75 transition-opacity duration-150 active:translate-y-0.1 active:shadow-none active:opacity-90  sm:mr-6">
                Buy SCAM -{'>'}
              </button>
            </a>
          </Link>
