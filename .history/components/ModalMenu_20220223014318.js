...
const ModalMenu = ({ pathname, pathnameHandler }) => {
  return (
    <div className="inline-flex" id="main_menu">
      <ul className="flex flex-wrap" id="menu_nav">
        <button className="relative  px-1 py-2.5 group hover:bg-gray-100 cursor-pointer rounded-2xl mb-0" onClick={() => {pathnameHandler("/swap")}}>
          <Link href="/swap">
            <a
              className={`${
          ...
          <ul className="absolute left-0 top-0 mt-10 py-1  w-[280px] rounded-2xl border shadow-sm bg-white z-10 hidden group-hover:block">
            ...
            >
              <Link href="/liquidity">
                ...
                >
                <button onClick={() => {pathnameHandler("/liquidity")}}>
