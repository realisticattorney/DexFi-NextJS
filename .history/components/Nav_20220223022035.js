  ...
  return (
    <div className="flex border-b-1.5 border-gray-200 p-0 items-center">
      ...
      {isUserWalletConnected ? (
        <button
          className="ml-auto mr-3 text-violet-900 font-bold py-0.8 px-5 shadow-slate-400 shadow-sm tracking-wide bg-gray-100 rounded-full relative hover:opacity-80 cursor-pointer"
          disabled={true}
        >
