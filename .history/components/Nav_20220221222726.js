...
import ProfileMenu from './SimpleMenu.js';
...
const Nav = () => {
  ...
  const menus = ["Exchange", "Wallet", "Profile", "Settings"];
  return (
    <div className="flex border-b-1.5 border-gray-200 p-0 items-center">
      ...
      <div>
        <ProfileMenu menus={menus} active={true} key={1} />
        <ProfileMenu menus={menus} active={true} key={2} />
      </div>
      <Link href="/swap">
