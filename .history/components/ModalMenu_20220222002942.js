  ...
  return (
    <div className="inline-flex" id="main_menu">
      ...
      >
        ...
        >
          <a
            className="font-semibold whitespace-no-wrap  hover:text-blue-800"
          ...
          <ul className="absolute left-0 top-0 mt-10 p-2 rounded-lg shadow-lg bg-white z-10 hidden group-hover:block">
            <li className="p-1 whitespace-no-wrap rounded-full text-sm md:text-base  hover:text-gray-800 hover:bg-gray-100">
              <a
                className="px-2 py-1"
