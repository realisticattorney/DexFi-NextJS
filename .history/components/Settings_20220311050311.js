              ...
              <div className="w-full p-4 pb-3 sm:p-6 bg-white rounded-br-3xl rounded-bl-3xl">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex justify-between my-4">
                    <button className={`shadow-sm ${slippage === 0.1 ? "text-white bg-dexfi-cyan" : "text-dexfi-cyan bg-gray-100"}  py-0.5 px-4 bg-dexfi-cyan  rounded-3xl font-bold hover:opacity-75 transition-opacity duration-150 active:translate-y-0.1 active:shadow-none active:opacity-90`}>
                      0.1%
                    </button>
