            ...
            <Fade in={openWallet}>
              <Paper sx={modalstyle}>
                <MenuList sx={{
                  ...
                  <div className="flex  text-xl font-medium text-dexfi-violet appBackground border-b mb-4 rounded-tl-3xl border-gray-300 rounded-tr-3xl">
                    <h1 className="p-5">Your Wallet</h1>
                  </div>
                  <div className="w-full p-5 bgg"></div>
