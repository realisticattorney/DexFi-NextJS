...
const RemovePanel = ({ address, currency, backCurrency }) => {
  ...
  return (
    <div className="flex flex-col p-5">
      ...
      <button className="w-full hover:opacity-75 mt-3.5 transition-opacity duration-150  bg-dexf shadow-sm text-white font-bold py-2 px-12 rounded-2xl active:translate-y-0.1 active:shadow-none active:opacity-90">
        Remove Liquidity
      </button>
    </div>
  );
