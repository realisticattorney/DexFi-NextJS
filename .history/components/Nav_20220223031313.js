          ...
          >
            <Fade in={openWallet}>
              <Paper sx={modalstyle}>
                ...
                >
                  <div className="flex  text-xl font-bold text-dexfi-violet appBackground border-b-2  rounded-tl-3xl border-gray-300 rounded-tr-3xl">
                    <h1 className="p-5">Your Wallet</h1>
                  </div>
                  <div className="w-full p-7 border-gray-300 border-b  bg-gray-50"></div>
                  <div className="w-full p-7 border-gray-300 border-b  bg-white"></div>
