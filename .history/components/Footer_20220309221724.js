      ...
      <div className="grid col-span-3 grid-cols-1 mx-3 sm:mx-6  grid-flow-row    sm:grid-cols-4  mt-8">
        <div className="inline-flex col-span-1 row-span-1 mb-4 sm:mb-0">
          <ul className="flex-col space-y-1.7 ">
            ...
            <li className="hover:underline cursor-pointer"><Link href="/accessibility"><a>Contact</li>
            <li className="hover:underline cursor-pointer"><Link href="/accessibility"><a>Brand</li>
            <li className="hover:underline cursor-pointer"><Link href="/accessibility"><a>Blog</li>
            <li className="hover:underline cursor-pointer"><Link href="/accessibility"><a>Community</li>
